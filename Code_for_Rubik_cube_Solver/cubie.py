...
basicMoveCube[Color.W] = CubieCube(cpU, coU, epU, eoU)
basicMoveCube[Color.R] = CubieCube(cpR, coR, epR, eoR)
basicMoveCube[Color.G] = CubieCube(cpF, coF, epF, eoF)
basicMoveCube[Color.Y] = CubieCube(cpD, coD, epD, eoD)
basicMoveCube[Color.O] = CubieCube(cpL, coL, epL, eoL)
